...
def generate_report():
    ...
    # Create a new window for report display
    report_window = Toplevel(root)
    report_window.title("Traffic Analysis Report")

    # Embed the pie chart into the Tkinter window using FigureCanvasTkAgg
    ...
    # Embed the scatter plot into the Tkinter window using FigureCanvasTkAgg
